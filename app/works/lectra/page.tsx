  ...
  return (
    ...
    <main style={{ background: "#050a06", minHeight: "100vh", overflowX: "hidden" }}>
      ...
      <div style={{ padding: "32px 48px", maxWidth: "1200px", margin: "0 auto" }}>
        <Link href="/" onMouseEnter={onEnter} onMouseLeave={onLeave} style={{ display: "inline-flex", alignItems: "center", gap: "10px", ...m, fontSize: "12px", color: "rgba(240,244,241,0.45)", textDecoration: "none", letterSpacing: "0.08em", transition: "color 0.2s" }}
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 48px 120px" }}>
        ...
        {/* ── NEXT PROJECT ── */}
        <Link href="/works/vimeworld" onMouseEnter={onEnter} onMouseLeave={onLeave} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "40px 48px", border: "1px solid rgba(240,244,241,0.08)", textDecoration: "none", transition: "border-color 0.3s, background 0.3s" }}
        ...
        >
          <div>
            ...
            <div style={{ ...s, fontWeight: 800, fontSize: "28px", color: "#f0f4f1", letterSpacing: "-0.02em" }}>VimeWorld ESC Menu</div>
          </div>
