    ...
    <>
      ...
      <main style={{ background: "#050a06", minHeight: "100vh", overflowX: "hidden" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 48px 120px" }}>
          ...
          {/* NEXT PROJECT */}
          <Link href="/works/lectra" onMouseEnter={onEnter} onMouseLeave={onLeave}
          ...
          >
            <div>
              ...
              <div style={{ ...s, fontWeight: 800, fontSize: "28px", color: "#f0f4f1", letterSpacing: "-0.02em" }}>Lectra — AI Note-Taking App</div>
            </div>
